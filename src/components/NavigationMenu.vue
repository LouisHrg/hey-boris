...
<nav class="flex items-center justify-between flex-wrap p-8">
    ...
    <div class="w-full lg:flex items-center lg:w-auto sm:block" v-bind:class="{'xs:hidden': menu}">
        ...
        <a href="#" v-scroll-to="'#testimonials'" class="block mt-4 lg:inline-block sm:text-right lg:mt-0 font-medium no-underline text-grey-lightest hover:text-main-green">
        temoignages
      </a>
    </div>
</nav>
